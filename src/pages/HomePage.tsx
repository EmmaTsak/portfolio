...
export function HomePage() {
  ...
  return <>
    ...
    <section className="section" id="contact"><div className="container contact-card"><div><p className="eyebrow">Contact</p><h2>Looking for a developer who cares how the software behaves?</h2><p>I’m interested in software-development roles, with quality engineering and UI/UX as complementary strengths.</p></div><div className="contact-actions"><a className="button button--primary" href={`mailto:${profile.email}`}><Mail/>Email me</a><button className="button button--ghost" onClick={copyEmail}>Copy email</button><a href={profile.github} target="_blank" rel="noreferrer"><Github/>GitHub</a><a href={profile.linkedin} target="_blank" rel="noreferrer"><Linkedin/>LinkedIn</a></div></div></section>
  </>;
}
