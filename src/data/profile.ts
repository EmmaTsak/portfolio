...
export const experience = [
  {
    ...
    company: 'Valmore · Athens',
    points: [
      'Developed, tested and maintained application features within agile development cycles.',
      'Created and executed Jest test scripts to identify defects earlier in the development process.',
      'Reproduced and investigated defects using structured troubleshooting and root-cause analysis.',
